...
import IFrameSVG from "./components/IFrameSVG";
import IFrameExcelCheckList from "./components/IFrameExcelCheckList";
    ...
    const handleExportExcel = async (e) => {
        ...
        try {
            ...
            if (
                ...
                &&  !valueSelect.id.includes("A-TEDCO-1") &&  !valueSelect.id.includes("HCM") 
            ) {
                                    ...
                                    { licenseLockLV1 === true || IsDemoUI === true  ? <div></div>:   <Grid container spacing={0.5}>
                                            {valueSelect ? (
                                                <>
                                                    ...
                                                    >
                                                        {/* <div> */}
                                                          { valueSelect.id.includes("_") ||  valueSelect.id.includes("CONG-NGHIEP-VIET-2") || valueSelect.id.includes("A-TEDCO-1") || valueSelect.id.includes("A-BIENTAN-1") || valueSelect.id.includes("HCM")? <ChartTab endDate={endDate} startDate={startDate} deviceId={valueSelect.id} inputLstSensor={listSensor}/>
